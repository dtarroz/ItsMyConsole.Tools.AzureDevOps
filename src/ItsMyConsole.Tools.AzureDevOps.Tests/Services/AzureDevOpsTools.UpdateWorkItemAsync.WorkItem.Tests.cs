...
public class AzureDevOpsTools_UpdateWorkItemAsync_WorkItem_Tests
{
    [Fact]
    public async Task UpdateWorkItemAsync_Server_Url_Fail() {
        ...
        await Assert.ThrowsAsync<HttpRequestException>(() => azureDevOpsTools.UpdateWorkItemAsync(new WorkItem(), workItemUpdateFields));
    }
    ...
    public async Task UpdateWorkItemAsync_Server_PersonalAccessToken_Fail() {
        ...
        Exception exception = await Assert.ThrowsAsync<Exception>(async () => {
            await azureDevOpsTools.UpdateWorkItemAsync(new WorkItem(), workItemUpdateFields);
        });
    ...
    public async Task UpdateWorkItemAsync_Fields_Null() {
        ...
        Exception exception = await Assert.ThrowsAsync<ArgumentNullException>(async () => {
            await azureDevOpsTools.UpdateWorkItemAsync(new WorkItem(), null);
        });
    ...
    public async Task UpdateWorkItemAsync_Fields_Empty() {
        ...
        WorkItem workItemUpdate = await azureDevOpsTools.UpdateWorkItemAsync(workItem, workItemUpdateFields);
    ...
    public async Task UpdateWorkItemAsync_Id_NotExists() {
        ...
        Exception exception = await Assert.ThrowsAsync<Exception>(async () => {
            await azureDevOpsTools.UpdateWorkItemAsync(workItem, workItemUpdateFields);
        });
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_OriginalEstimate_Null() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.OriginalEstimate = null;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_OriginalEstimate_Negative() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.OriginalEstimate = -1;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_OriginalEstimate_Zero() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.OriginalEstimate = 0;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_OriginalEstimate_Double() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.OriginalEstimate = 3.14159265;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_OriginalEstimate_Int() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.OriginalEstimate = 10;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_OriginalEstimate_SameValue() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.OriginalEstimate = workItem.OriginalEstimate;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_RemainingWork_Null() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.RemainingWork = null;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_RemainingWork_Negative() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.RemainingWork = -1;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_RemainingWork_Zero() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.RemainingWork = 0;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_RemainingWork_Double() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.RemainingWork = 3.14159265;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_RemainingWork_Int() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.RemainingWork = 10;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_RemainingWork_SameValue() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.RemainingWork = workItem.RemainingWork;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_CompletedWork_Null() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.CompletedWork = null;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_CompletedWork_Negative() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.CompletedWork = -1;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_CompletedWork_Zero() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.CompletedWork = 0;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_CompletedWork_Double() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.CompletedWork = 3.14159265;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_CompletedWork_Int() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.CompletedWork = 10;
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_CompletedWork_SameValue() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        workItemUpdateFields.CompletedWork = workItem.CompletedWork;
    ...
    public async Task UpdateWorkItemAsync_SameCall() {
        ...
        WorkItem workItemUpdate = await azureDevOpsTools.UpdateWorkItemAsync(workItem, workItemUpdateFields);
        await azureDevOpsTools.UpdateWorkItemAsync(workItemUpdate, workItemUpdateFields);
        WorkItem workItemGet = await azureDevOpsTools.GetWorkItemAsync(workItem.Id);
        await azureDevOpsTools.DeleteWorkItemAsync(workItem.Id);
    ...
    public async Task UpdateWorkItemAsync_Rev3() {
        ...
        workItem = await azureDevOpsTools.UpdateWorkItemAsync(workItem, workItemUpdateFields);
    ...
    [Fact]
    public async Task UpdateWorkItemAsync_Rev3_Fail() {
        AzureDevOpsTools azureDevOpsTools = new AzureDevOpsTools(ConfigForTests.GetAzureDevOpsServer());
        WorkItemCreateFields workItemCreateFields = ConfigForTests.GetWorkItemCreateFields();
        WorkItem workItem = await azureDevOpsTools.CreateWorkItemAsync(workItemCreateFields);
        WorkItemUpdateFields workItemUpdateFields = ConfigForTests.GetWorkItemUpdateFields();
        ...
        Exception exception = await Assert.ThrowsAsync<Exception>(async () => {
            WorkItemUpdateFields workItemUpdateFields2 = ConfigForTests.GetWorkItemUpdateFields();
            workItemUpdateFields2.Title = "TITLE_UPDATE_2";
            await azureDevOpsTools.UpdateWorkItemAsync(workItem, workItemUpdateFields2);
        });

        WorkItem workItemGet = await azureDevOpsTools.GetWorkItemAsync(workItem.Id);
        await azureDevOpsTools.DeleteWorkItemAsync(workItem.Id);

        Assert.StartsWith("VS403351: ", exception.Message);
        Assert.Contains($" {workItem.Rev + 1} ", exception.Message);
        Assert.Contains($" {workItem.Rev}.", exception.Message);
        WorkItemAssert.CheckUpdate(workItem, workItemUpdateFields, workItemUpdate);
        WorkItemAssert.Equal(workItemUpdate, workItemGet);
    }
}
